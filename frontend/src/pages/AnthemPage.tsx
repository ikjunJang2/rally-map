...
const MELODY: { s: string; n: NoteName; d?: number }[] = [
  ...
  { s: '대', n: 'C5' }, { s: '한', n: 'B4' }, { s: '으', n: 'A4' }, { s: '로', n: 'G4', d: 2 },
  { s: '길', n: 'E5' }, { s: '이', n: 'G4' },
