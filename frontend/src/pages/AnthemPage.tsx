 ...
 * 멜로디는 사용자가 준 1절 계이름표를 그대로 옮긴 데이터(MELODY) — '들어보기'로 확인 가능.
 */

// 계이름 7음. 애국가는 솔·라·시가 으뜸음 도보다 아래 → 솔라시(낮음) 도레미파(높음) 순.
const NOTES = { G4: 392.0, A4: 440.0, B4: 493.88, C5: 523.25, D5: 587.33, E5: 659.25, F5: 698.46 } as const;
type NoteName = keyof typeof NOTES;
const SOLFEGE: Record<NoteName, string> = { G4: '솔', A4: '라', B4: '시', C5: '도', D5: '레', E5: '미', F5: '파' };
const KEYS = (Object.keys(NOTES) as NoteName[]).sort((a, b) => NOTES[a] - NOTES[b]);

// 애국가 1절 — 사용자 제공 계이름표 그대로. '~'는 앞 글자를 이어 부르는 음(멜리스마).
const MELODY: { s: string; n: NoteName }[] = [
  // 동해물과 백두산이 마르고 닳도록 (솔 도시라 도 솔미솔 도레미 파미레)
  { s: '동', n: 'G4' }, { s: '해', n: 'C5' }, { s: '물', n: 'B4' }, { s: '과', n: 'A4' },
  { s: '백', n: 'C5' }, { s: '두', n: 'G4' }, { s: '산', n: 'E5' }, { s: '이', n: 'G4' },
  { s: '마', n: 'C5' }, { s: '르', n: 'D5' }, { s: '고', n: 'E5' },
  { s: '닳', n: 'F5' }, { s: '도', n: 'E5' }, { s: '록', n: 'D5' },
  // 하느님이 보우하사 우리나라 만세 (솔파미레 도시라솔 미솔 도레레미도)
  { s: '하', n: 'G4' }, { s: '느', n: 'F5' }, { s: '님', n: 'E5' }, { s: '이', n: 'D5' },
  { s: '보', n: 'C5' }, { s: '우', n: 'B4' }, { s: '하', n: 'A4' }, { s: '사', n: 'G4' },
  { s: '우', n: 'E5' }, { s: '리', n: 'G4' }, { s: '나', n: 'C5' }, { s: '라', n: 'D5' },
  { s: '만', n: 'D5' }, { s: '세', n: 'E5' }, { s: '~', n: 'C5' },
  // 무궁화 삼천리 화려강산 (시도레시 미파솔미 레도시도레)
  { s: '무', n: 'B4' }, { s: '궁', n: 'C5' }, { s: '화', n: 'D5' }, { s: '~', n: 'B4' },
  { s: '삼', n: 'E5' }, { s: '천', n: 'F5' }, { s: '리', n: 'G4' }, { s: '~', n: 'E5' },
  { s: '화', n: 'D5' }, { s: '려', n: 'C5' }, { s: '강', n: 'B4' }, { s: '산', n: 'C5' }, { s: '~', n: 'D5' },
  // 대한사람 대한으로 길이 보전하세 (솔파미레 도시라솔 미솔 도레레미도)
  { s: '대', n: 'G4' }, { s: '한', n: 'F5' }, { s: '사', n: 'E5' }, { s: '람', n: 'D5' },
  { s: '대', n: 'C5' }, { s: '한', n: 'B4' }, { s: '으', n: 'A4' }, { s: '로', n: 'G4' },
  { s: '길', n: 'E5' }, { s: '이', n: 'G4' },
  { s: '보', n: 'C5' }, { s: '전', n: 'D5' }, { s: '하', n: 'D5' }, { s: '세', n: 'E5' }, { s: '~', n: 'C5' },
];
  ...
  return (
    <section aria-label="애국가 건반 게임">
      ...
      <p className="notice">
        ...
        멜로디는 주신 1절 계이름표 그대로예요(한 옥타브). <b>들어보기</b>로 확인하시고, 음이 더 다듬어졌으면
        하는 부분이 있으면 알려주세요. 잠시 쉬어가며 함께 부르는 애국가 🇰🇷
      </p>
    </section>
  );
}
